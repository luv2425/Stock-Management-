...
checkoutBtn.addEventListener('click', function () {
    ...
    alert("✅ Checkout complete — stock updated and invoice generated.");
});
...
gstInvoiceBtn.addEventListener('click', function () {
    ...
    alert("✅ Checkout complete — stock updated and GST invoice generated.");
});
...
function checkAlerts(product) {
    ...
    if (q < 100 && !alert100Shown) {
        alert(`⚠️ Warning: ${product.name} stock is below 100 (${product.quantity} ${product.unit})`);
        alert100Shown = true;
    }
    if (q < 50 && !alert50Shown) {
        alert(`❗ Critical: ${product.name} stock is below 50 (${product.quantity} ${product.unit})`);
        alert50Shown = true;
    }
}
